...
if [ -n "${INSTALLER_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/mitsuhiko/insta/releases/download/1.42.2"
fi
...
The installer for cargo-insta 1.42.2

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/mitsuhiko/insta/releases/download/1.42.2
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "cargo-insta-aarch64-apple-darwin.tar.xz")
            ...
            _checksum_value="df2d52d736ba8e6870444b19c42cf780d168c742f54a39baa68971b5c2846c71"
            _bins="cargo-insta"
        ...
        "cargo-insta-x86_64-apple-darwin.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="bc5357024aedd587b02c7ceb25dd60474ef3589414ff9708dd3b9f96c456f49f"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            _libs=""
            _libs_js_array=""
        ...
        "cargo-insta-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="aa54fc465a8e12f3d36fe34971f681f69cc34a2ec0bf57d91da5258dfe6c35cf"
        ...
        "cargo-insta-x86_64-unknown-linux-gnu.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="3a3bef89b37e2286b3c0666731e508d4dfb29755fe3fffe0d8e4cac54abf73b0"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            _libs=""
            _libs_js_array=""
        ...
        "cargo-insta-x86_64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="f50167aac6691980d07413679c166243f47888d1c9eb43af801308acf583726e"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            _libs=""
            _libs_js_array=""
