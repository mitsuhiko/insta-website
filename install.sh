...
APP_VERSION="1.41.1"
ARTIFACT_DOWNLOAD_URL="${INSTALLER_DOWNLOAD_URL:-https://github.com/mitsuhiko/insta/releases/download/1.41.1}"
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"install_prefix":"AXO_INSTALL_PREFIX","provider":{"source":"cargo-dist","version":"0.12.0"},"source":{"app_name":"cargo-insta","name":"insta","owner":"mitsuhiko","release_type":"github"},"version":"1.41.1"}
EORECEIPT
# Are we happy with this same path on Linux and Mac?
RECEIPT_HOME="${HOME}/.config/cargo-insta"
...
The installer for cargo-insta 1.41.1

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/mitsuhiko/insta/releases/download/1.41.1
...
download_binary_and_run_installer() {
    ...
    case "$_arch" in 
        "aarch64-apple-darwin")
            _artifact_name="cargo-insta-aarch64-apple-darwin.tar.xz"
            _zip_ext=".tar.xz"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            ;;
        "x86_64-apple-darwin")
            _artifact_name="cargo-insta-x86_64-apple-darwin.tar.xz"
            _zip_ext=".tar.xz"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            ;;
        "x86_64-unknown-linux-gnu")
            _artifact_name="cargo-insta-x86_64-unknown-linux-gnu.tar.xz"
            _zip_ext=".tar.xz"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            ;;
        "x86_64-unknown-linux-musl-dynamic")
            _artifact_name="cargo-insta-x86_64-unknown-linux-musl.tar.xz"
            _zip_ext=".tar.xz"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            ;;
