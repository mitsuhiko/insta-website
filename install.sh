...
if [ -n "${INSTALLER_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/mitsuhiko/insta/releases/download/1.43.1"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.27.0"},"source":{"app_name":"cargo-insta","name":"insta","owner":"mitsuhiko","release_type":"github"},"version":"1.43.1"}
EORECEIPT
RECEIPT_HOME="${XDG_CONFIG_HOME:-$HOME/.config}/cargo-insta"
...
The installer for cargo-insta 1.43.1

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/mitsuhiko/insta/releases/download/1.43.1
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "cargo-insta-aarch64-apple-darwin.tar.xz")
            ...
            _checksum_value="296d0cd3110b18fcf87033bec765cc190b8366b38f1e16a2daff0df9421df359"
            _bins="cargo-insta"
        ...
        "cargo-insta-x86_64-apple-darwin.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="00a66f8cc0906cac975fafdb72ddb9d15dcb967df30c708099ec184c91a7f570"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            _libs=""
            _libs_js_array=""
        ...
        "cargo-insta-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="d35c381a617ff177901ba74adbdbc981ab5acf4ba73328c9fa28ff3f8a707b03"
        ...
        "cargo-insta-x86_64-unknown-linux-gnu.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="e36eba4013f5b31d5d29e2fc7976a6df6177eff6753221c74c922e8a957804d5"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            _libs=""
            _libs_js_array=""
        ...
        "cargo-insta-x86_64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="2f39682ac06712afc56ee651c00e72ec6dd7ba3a3a92b2000caa2b29add1c716"
            _bins="cargo-insta"
            _bins_js_array='"cargo-insta"'
            _libs=""
            _libs_js_array=""
