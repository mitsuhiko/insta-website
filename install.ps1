...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/mitsuhiko/insta/releases/download/1.42.2',
...
if ($env:INSTALLER_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/mitsuhiko/insta/releases/download/1.42.2"
}
