...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/mitsuhiko/insta/releases/download/1.43.1',
...
if ($env:INSTALLER_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/mitsuhiko/insta/releases/download/1.43.1"
}
